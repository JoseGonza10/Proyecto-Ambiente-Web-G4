					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Contacto</h1>
								<p class="mb-4">Llena el formulario con tu solicitud y dejanos saber tus opiniones o consultas y pronto te recibirás nuestra respuesta por correo electrónico.</p>
								<p><a href="" class="btn btn-secondary me-2">Ver paquetes</a>
							</div>
						</div>
						<div class="col-lg-7">
              ...
              <div class="row mb-5">
                <div class="col-lg-4">
                  <div  class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                    ...
                    <div class="service-contents">
                      <p>San Jose, El Rodeo de Coronado, San José, Costa Rica</p>
                ...
                <div class="col-lg-4">
                  <div  class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                    ...
                    <div class="service-contents">
                      <p>dannywaylondon@hotmail.com</p>
                    </div> <!-- /.service-contents-->
                  </div> <!-- /.service -->
                </div>
