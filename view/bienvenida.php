...
<body>
    <div class="container">
        <nav>
            ...
            <header>
                <h1>¡Bienvenido!</h1>
                <h2>Colegios - Empresas - Amigos - Familiares</h2>
                <h3>El juego mas popular de USA, ahora el mejor y + grande de Paintball en C.R</h3>
</header>
</nav>
</body>
        </html>=======
...
<head>
    <meta charset="UTF-8">
    <title>UnderFire Paintball CR</title>
